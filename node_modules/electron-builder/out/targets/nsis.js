...
class NsisTarget extends (_core || _load_core()).Target {
    ...
    buildAppPackage(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const archiveFile = _path.join(_this2.outDir, `${packager.appInfo.name}-${packager.appInfo.version}-${(_core || _load_core()).Arch[arch]}.nsis.${format}`);
            ...
            if (options.differentialPackage) {
                ...
                const blockMapFile = _path.join(_this2.outDir, `${packager.appInfo.name}-${packager.appInfo.version}-${(_core || _load_core()).Arch[arch]}.blockMap.yml`);
    ...
    computeFinalScript(originalScript, isInstaller) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            taskManager.add((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
                ...
                const licensePage = yield _this8.computeLicensePage();
    ...
    computeLicensePage() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const license = yield packager.getResource(_this9.options.license, "license.rtf", "license.txt", "eula.rtf", "eula.txt", "LICENSE.rtf", "LICENSE.txt", "EULA.rtf", "EULA.txt", "LICENSE.RTF", "LICENSE.TXT", "EULA.RTF", "EULA.TXT");
            if (license != null) {
