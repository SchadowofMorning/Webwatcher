...
class WinPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
    constructor(info) {
        ...
        this.computedPublisherSubjectOnWindowsOnly = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
    ...
    signAndEditResources(file, arch, outDir) {
        var _this4 = this;
    ...
    signApp(packContext) {
        return this.signAndEditResources(_path.join(packContext.appOutDir, `${this.appInfo.productFilename}.exe`), packContext.arch, packContext.outDir);
    }
}
